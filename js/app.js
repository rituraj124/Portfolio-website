...
$(document).ready(function(){
  ...
  var waypoint = new Waypoint({
    ...
    handler: function() {
      ...
      p[7].setAttribute("style", "width:85%;transition:2.5s all;");
      p[8].setAttribute("style", "width:90%;transition:2.5s all;");
      p[9].setAttribute("style", "width:70%;transition:2.5s all;");
      p[10].setAttribute("style", "width:95%;transition:2.5s all;");
      p[11].setAttribute("style", "width:80%;transition:2.5s all;");
      p[12].setAttribute("style", "width:88%;transition:2.5s all;");
  ...
  //   });
    ...
    strings: ["Rituraj Das", "a Developer","a Designer","a Businessman"],
    smartBackspace: true,
     typeSpeed: 100,
     backSpeed: 100,
     loop: true,
